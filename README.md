...
```
Для работы системы логирования создайте новый проект на [сайте Rollbar](https://rollbar.com/). Получите токен и определите переменную окружения `ROLLBAR_TOKEN`. В файл `.env` добавьте код:
```sh
